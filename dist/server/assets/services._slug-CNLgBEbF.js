import { E as invariant, H as reactUse, L as isModuleNotFoundError, Y as __toESM, _ as trimPathLeft, c as require_jsx_runtime, i as useRouter, p as joinPaths, q as require_react, v as trimPathRight } from "./react-dom-D3rPRm8N.js";
import { o as redirect, s as rootRouteId, t as useMatch } from "./useMatch-CV-OaCK4.js";
import { v as siteConfig, y as Link } from "./button-lECp910C.js";
...
var $$splitComponentImporter = () => import("./services._slug-Do9zmSjr.js");
var Route = createFileRoute("/services/$slug")({
	head: ({ params }) => {
		const service = siteConfig.services.find((item) => item.slug === params.slug);
		return { meta: seo({
			title: service ? `${service.title} | ${siteConfig.businessName}` : `Service | ${siteConfig.businessName}`,
...
//#endregion
export { createRootRoute as a, createFileRoute as i, seo as n, lazyRouteComponent as r, Route as t };
